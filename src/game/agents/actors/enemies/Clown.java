...
public class Clown implements Actor {
	...
	public Clown(int[] coords, int roomNumber) {
		// set at the start
		this.coords = coords;
		this.roomNumber = roomNumber;
		// Set these depending on the actor created
		health = 1;
		actorID = ActorID.CLOWN;
	...
	public void update(GameBoard gameBoard) {
		if (gameBoard.getTools().getDistanceBetweenCoords(coords, gameBoard.getPlayer().getCoords()) < 5) {
